...
class AWIModel(object):
    ...
    def _new_inference(self, encoder_inputs, encoder_outputs):
        ...
        cell = tf.contrib.rnn.DeviceWrapper(tf.contrib.rnn.LSTMCell(512))
        attention_mechanism = tf.contrib.seq2seq.LuongAttention(512, encoder_outputs)
        attn_cell = tf.contrib.seq2seq.DynamicAttentionWrapper(
            cell, attention_mechanism, attention_size=256)
        attn_cell = tf.contrib.rnn.DeviceWrapper(attn_cell)
        top_cell = tf.contrib.rnn.DeviceWrapper(tf.contrib.rnn.LSTMCell(512))
        multi_cell = tf.contrib.rnn.MultiRNNCell([attn_cell, top_cell])
